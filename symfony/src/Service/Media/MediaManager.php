...
class MediaManager
{
    ...
    public function createFromUrl($url, $ext): Media
    {
        $tempPath = rtrim(sys_get_temp_dir(), DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . uniqid() . '.' . $ext;
        ...
        $media = $this->createMedia($tempPath, $hash, $context, $providerName, 'gggg' . $ext);
